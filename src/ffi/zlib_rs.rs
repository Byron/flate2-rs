//! Implementation for the `zlib-rs` backend.
...
pub const MZ_DEFAULT_WINDOW_BITS: std::os::raw::c_int = 15;

impl From<::zlib_rs::Status> for crate::mem::Status {
    fn from(status: ::zlib_rs::Status) -> Self {
        match status {
